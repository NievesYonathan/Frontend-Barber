...
const CrudMetodosPago = () => {
  ...
  const fetchMetodos = async () => {
    const response = await axios.get('https://barberback.azurewebsites.net/api/metodo-pago');
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    if (editId) {
      await axios.put(`https://barberback.azurewebsites.net/api/metodo-pago/${editId}`, formData);
      setEditId(null);
    } else {
      await axios.post('https://barberback.azurewebsites.net/api/metodo-pago', formData);
    }
    fetchMetodos();
  ...
  const handleDelete = async id => {
    await axios.delete(`https://barberback.azurewebsites.net/api/metodo-pago/${id}`);
    fetchMetodos();
  };

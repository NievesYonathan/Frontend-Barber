...
const CrudRecibos = () => {
  ...
  const fetchRecibos = async () => {
    const response = await axios.get('https://barberback.azurewebsites.net/api/recibos');
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    if (editId) {
      await axios.put(`https://barberback.azurewebsites.net/api/recibos/${editId}`, formData);
      setEditId(null);
    } else {
      await axios.post('https://barberback.azurewebsites.net/api/recibos', formData);
    }
    fetchRecibos();
    setFormData({
      Fecha: '',
  ...
  const handleDelete = async id => {
    await axios.delete(`https://barberback.azurewebsites.net/api/recibos/${id}`);
    fetchRecibos();
  };

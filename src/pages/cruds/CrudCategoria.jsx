...
const CrudCategorias = () => {
  ...
  const fetchCategorias = async () => {
    const response = await axios.get('https://barberback.azurewebsites.net/api/categorias');
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    if (editId) {
      await axios.put(`https://barberback.azurewebsites.net/api/categorias/${editId}`, formData);
      setEditId(null);
    } else {
      await axios.post('https://barberback.azurewebsites.net/api/categorias', formData);
    }
    fetchCategorias();
  ...
  const handleDelete = async id => {
    await axios.delete(`hhttps://barberback.azurewebsites.net/api/categorias/${id}`);
    fetchCategorias();
  };
